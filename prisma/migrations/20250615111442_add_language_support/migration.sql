...
-- CreateEnum
CREATE TYPE "ModuleType" AS ENUM ('TEXT_IMAGE', 'PARALLAX', 'HERO', 'GALLERY', 'VIDEO', 'CONTACT_FORM', 'TESTIMONIALS');
...
-- AddForeignKey
ALTER TABLE "page_modules" ADD CONSTRAINT "page_modules_pageId_fkey" FOREIGN KEY ("pageId") REFERENCES "pages"("id") ON DELETE CASCADE ON UPDATE CASCADE;
